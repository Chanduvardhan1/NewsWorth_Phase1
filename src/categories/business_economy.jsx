...
function Business_economy() {
  ...
  const filteredContent = useMemo(() => {
    const filtered = imageData.filter(item => item.content_categories === "Business & Economy");
    console.log("Filtered Business & Economy content: ", filtered);  // Log the filtered content
    return filtered;
  }, [imageData]);
