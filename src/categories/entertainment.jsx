...
function Entertainment(){
  ...
  const filteredContent = useMemo(() => {
    const filtered = imageData.filter(item => item.content_categories === "Entertainment");
    console.log("Filtered Entertainment content: ", filtered);  // Log the filtered content
    return filtered;
  }, [imageData]);
