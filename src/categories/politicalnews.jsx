...
function PoliticalNews() {
  ...
  // Fetch data for Political News category
  ...
  // Filter content by Political News category
  const filteredContent = useMemo(() => {
    const filtered = imageData.filter(item => item.content_categories === "Political News");
    console.log("Filtered Political News content: ", filtered);
    return filtered;
  }, [imageData]);
          ...
          {loading ? (
            ...
            filteredContent
              ...
              .map((contentItem, index) => (
                <div key={`${contentItem.content_id}-${index}`} className="w-full max-w-sm rounded overflow-hidden shadow-lg bg-white">
                  {/* Image Section */}
