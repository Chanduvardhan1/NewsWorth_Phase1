...
function Crime_law(){
  ...
  const filteredContent = useMemo(() => {
    const filtered = imageData.filter(item => item.content_categories === "Crime & Law");
    console.log("Filtered Crime & Law content: ", filtered);  // Log the filtered content
    return filtered;
  }, [imageData]);
